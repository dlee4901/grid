...
// {
//     public HashSet<Vector2Int> GetSelectableTiles(TileSelection tileSelection, Position<Tile> tiles, Position<Unit> units)
//     {
//         HashSet<Vector2Int> selectableTiles = new();
//         //Unit unit = units.Get(index);
//         int origin = tileSelection.Origin;
//         if (tiles.Get(origin) == null) return selectableTiles;
//         Vector2Int initialPosition = (Vector2Int)tiles.GetVector(origin);
